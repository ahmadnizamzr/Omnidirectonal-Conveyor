...
# Delay setting
# ======================
capture_delay = 0.3  # delay 120 ms setelah object terdeteksi
trigger_time = None
...
while True:
    ...
    if proximity == 1 and last_proximity == 0:
        print("Object detected → wait capture delay")
        trigger_time = time.time()
        waiting_capture = True

    # ======================
    # tunggu delay sebelum scan
    # ======================
    if waiting_capture and (time.time() - trigger_time) > capture_delay:
