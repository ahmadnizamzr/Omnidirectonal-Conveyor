...
def wait_prox_clear(bus, addr):
    print(f"Menunggu proximity slave {addr} reset... / nilai 0")
    while True:
        prox = read_prox(bus, addr)
...
def process_input(bus, val):
    ...
    # =====================
        ...
        # pastikan nilai prox semua 0 sebelum mulai
        wait_prox_clear(bus, SLAVE_1)
        wait_prox_clear(bus, SLAVE_2)
        ...
        print("Gunakan:")
        print("cell 1 : 4 kanan / 8 kiri")
        print("cell 2 : 14 kanan / 18 kiri")
        print("cell 3 : 24 kanan / 28 kiri")
        print("lurus → 30 ")
