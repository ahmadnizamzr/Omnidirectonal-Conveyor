...
// alamat I2C slave
// #define I2C_SLAVE_ADDR 0x01 // alamat 1
// #define I2C_SLAVE_ADDR 0x0B // alamat 11
#define I2C_SLAVE_ADDR 0x15 // alamat 21
...
void loop()
{
    ...
    //
    proxDetected = (digitalRead(PIN_PROX) == LOW);
    ...
    if (millis() - lastPrint > 1000)
    {
        ...
        Serial.print(digitalRead(PIN_PROX));
        Serial.print(" | DETECT = ");
        Serial.println(proxDetected);
    }
